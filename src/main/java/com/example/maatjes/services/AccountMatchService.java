...
//    public AccountMatchKey addAccountMatch(Long accountId, Long matchId) {
//        var accountMatch = new AccountMatch();
//        if (!accountRepository.existsById(accountId)) {throw new RecordNotFoundException();}
//        Account account = accountRepository.findById(accountId).orElse(null);
//        if (!matchRepository.existsById(matchId)) {throw new RecordNotFoundException();}
//        Match match = matchRepository.findById(matchId).orElse(null);
//        accountMatch.setAccount(account);
//        accountMatch.setMatch(match);
//        AccountMatchKey id = new AccountMatchKey(accountId, matchId);
//        accountMatch.setId(id);
//        accountMatchRepository.save(accountMatch);
//        return id;
//    }

    public AccountMatchKey addAccountMatch(Long accountId1, Long accountId2) {
        ...
        accountMatchRepository.save(accountMatch1);

        AccountMatch accountMatch2 = new AccountMatch();
        accountMatch2.setAccount(account2);
        accountMatch2.setMatch(match);
        AccountMatchKey id2 = new AccountMatchKey(accountId2, match.getId());
        accountMatch2.setId(id2);
        accountMatchRepository.save(accountMatch2);
